...
parser.add_argument('--model_id', type=str, default='20', help='model id')
parser.add_argument('--model', type=str, default='DLinear')

# data loader
parser.add_argument('--data', type=str, default='weibo', help='dataset type')
parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='weibo2016.csv', help='data file')
...
parser.add_argument('--label_len', type=int, default=5, help='start token length') # 106
parser.add_argument('--pred_len', type=int, default=6, help='prediction sequence length') # 106
parser.add_argument('--number', type=int, default=15, help='prediction sequence length') # 106
...
parser.add_argument('--enc_in', type=int, default=10, help='encoder input size')#7
parser.add_argument('--dec_in', type=int, default=10, help='decoder input size')#7
parser.add_argument('--c_out', type=int, default=1, help='output size')#7
...
parser.add_argument('--distil', action='store_false',
                    ...
                    default=True)
parser.add_argument('--dropout', type=float, default=0.1, help='dropout')# 0.05  0.1 最好zq
# parser.add_argument('--embed', type=str, default='timeF',
#                     help='time features encoding, opt ions:[timeF, fixed, learned]')
...
parser.add_argument('--model_optim', type=str, default='adam', help='使用的优化器，例如："adam", "sgd"')
...
parser.add_argument('--device', type=str, default='cuda',
                    help='Device to train the model -- [ cuda , cpu ]')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        if args.do_predict:
            print('>>>>>>>predicting : {}<<<<<<<<<<<<<<<<<<z<<<<<<<<<<<<<<<'.format(setting))
